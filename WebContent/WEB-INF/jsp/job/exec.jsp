	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">执行作业</div>
				<div class="panel-body">
					<div class="col-md-6">
						<div class="form-group">
							<label>作业ID</label>
							<input name="job_id" type="text" class="form-control" value="${requestScope.job.jobId}" disabled="disabled">
						</div>
						<div class="form-group">
							<label>作业名称</label>
							<input name="title" type="text" class="form-control" value="${requestScope.job.title}" disabled="disabled">
						</div>
						<div class="form-group">
							<label>命令</label>
							<textarea name="cmd" class="form-control" rows="3" disabled="disabled">${requestScope.job.cmd}</textarea>
						</div>
						<div class="form-group">
							<label>命令参数替换</label>
					   ...
					   <button type="submit" class="btn btn-primary" onclick="execJob()">执行</button>
